> Source: https://github.com/blackboardsh/electrobun/blob/main/docs/src/content/docs/electrobun/apis/tray.mdx · fetched 2026-05-24
...
See [Application Menu](/electrobun/apis/application-menu) for more info on available properties for menu items.
