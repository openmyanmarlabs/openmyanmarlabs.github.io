> Source: https://github.com/blackboardsh/electrobun/blob/main/docs/src/content/docs/electrobun/apis/cli/cli-args.mdx · fetched 2026-05-24
...
Builds always target the current host platform and architecture. To build for multiple platforms, use CI runners for each OS/architecture (see [Cross-Platform Development](/electrobun/guides/cross-platform-development)).
...
Use `build.watchIgnore` in your config to exclude files from triggering rebuilds (e.g., generated assets). See [Build Configuration](/electrobun/apis/cli/build-configuration) for details.
