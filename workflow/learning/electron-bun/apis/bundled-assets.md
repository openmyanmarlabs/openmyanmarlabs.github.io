> Source: https://github.com/blackboardsh/electrobun/blob/main/docs/src/content/docs/electrobun/apis/bundled-assets.mdx · fetched 2026-05-24
...
> **Tip:** The property name for each view, in this case `mainview` can be anything you'd like. And you can specify as many views as you'd like. This maps directly to the path you would use when referencing a file so you can organize your assets.
...
> **Note:** **Notice that in the "copy" section the destination is `views/mainview/` which maps to the url `views://mainview/`.**
