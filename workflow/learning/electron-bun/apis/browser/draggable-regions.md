> Source: https://github.com/blackboardsh/electrobun/blob/main/docs/src/content/docs/electrobun/apis/browser/draggable-regions.mdx · fetched 2026-05-24

# Draggable Regions

> **Tip:** Configure an html element to function as a draggable region allowing you to move the native application window by clicking and dragging on the element.
...
> **Tip:** See the [BrowserWindow API](/electrobun/apis/browser-window) documentation for more details on `titleBarStyle` and `transparent` window options.
