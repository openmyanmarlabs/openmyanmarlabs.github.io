> Source: https://github.com/blackboardsh/electrobun/blob/main/docs/src/content/docs/electrobun/apis/browser/electroview-class.mdx · fetched 2026-05-24

# Electroview Class

> **Tip:** Instantiate Electrobun APIs in the browser.
...
Assuming you've wired up rpc on the bun side when creating the [BrowserWindow](/electrobun/apis/browser-window) you'll be able to call those bun functions from the browser.
